...
banner:
  text:
    - text: "🥳 快來在10分鐘內取走你的"
    - boldText: "特價午餐！"
    - text: "🥖 6吋鯰魚、蝦或鮪魚三明治（內含生菜、番茄、美乃滋、調味醬）—— 僅需$7.99（原價$10.99）。🥖 12吋鯰魚、蝦或鮪魚三明治（內含生菜、番茄、美乃滋、調味醬）—— 僅需$12.99（原價$17.99）。🌯 超級墨西哥餡餅 —— 僅需$12（原價$17）。🥪 墨西哥夾餅 —— 僅需$11.25（原價$16）。🌯 超級墨西哥捲餅 —— 僅需$12.90（原價$17.99）。"
...
sections:
  ...
  - type: "hero"
    ...
    addOrderOnlineBtn: false
    orderOnlineBtnInsteadText: "查看菜單與訂餐"
    addTableReservationBtn: false
    tableReservationBtnInsteadText: ""
    showOtherBtn: true
  ...
  - type: "gallery"
    ...
    bgOpacity: "" # 0~1
    title:
      - "Crabby Crabby Newark 菜單"
    titleColor: "#000000"
    description:
      - "Crabby Crabby Newark的美味等你來品藏!"
    descriptionColor: "#333333"
    folderPath: "menu"
    showImgName: false # true | false
    imgNameColor: "#000000"
  ...
  - type: "feature"
    ...
    titleColor: "#000000"
    description:
      - "在Crabby Crabby Newark餐廳，我們的使命簡單而強大：在每個細節中追求烹飪卓越。我們努力為顧客提供感官愉悅且難以忘懷的用餐體驗。"
    descriptionColor: "#000000"
    # title2:
  ...
  - type: "feature"
    ...
    titleColor: "#000000"
    description:
      - "我們很自豪地成為加州紐瓦克社區的積極一員，Crabby Crabby Newark餐廳致力於加強我們之間的聯繫。"
    descriptionColor: "#000000"
